...
import com.kreitek.jhipster.service.SongQueryService;
...
/**
 * REST controller for managing {@link com.kreitek.jhipster.domain.Song}.
 */
@RestController
@RequestMapping("/api")
public class SongResource {
    ...
    public SongResource(SongService songService, SongRepository songRepository, SongQueryService songQueryService) {
    ...
    public ResponseEntity<List<SongDTO>> getAllSongs(
        ...
        Page<SongDTO> page = songQueryService.findByCriteria(criteria, pageable);
